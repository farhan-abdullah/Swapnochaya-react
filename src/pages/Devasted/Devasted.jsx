   ...
   return (
      <div className="w-full md:h-[100vh]">
         <Parallax
            ...
            bgImage="https://demo1.imithemes.com/html/born-to-give/images/parallax5.jpg"
            bgImageAlt="the cat"
            strength={500}>
            <div className="md:absolute px-3 md:px-0 z-20 md:top-16 2xl:top-32 md:bottom-0 md:left-0  md:right-28">
               <div className="w-full  md:w-[365px] md:ml-[60%] p-[30px] bg-white">
                  <h2 className="text-[24px] font-semibold">
                     Nepal has been seriously devastated by the recent
                     earthquake.
                  </h2>
                  <p className="my-[30px] text-[15px] text-[#898989]">
                     Over 8,000 people have died (with death toll rising),
                     thousands more are injured, and countless more have been
                     displaced. Many homes, temples, and public monuments have
                     been destroyed throughout the affected areas.
                  </p>
