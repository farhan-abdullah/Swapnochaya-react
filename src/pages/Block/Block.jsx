...
const Block = () => {
	const cards = [
		{
			donatedImage: 'https://demo1.imithemes.com/html/born-to-give/images/causeg5.jpg',
			donatedTitle: 'Help relocate the refuses',
			TotalDonated: 21840,
		},
		{
			donatedImage: 'https://demo1.imithemes.com/html/born-to-give/images/causeg1.jpg',
			donatedTitle: 'Help relocate the refuses',
			TotalDonated: 21840,
		},
		{
			donatedImage: 'https://demo1.imithemes.com/html/born-to-give/images/causeg2.jpg',
			donatedTitle: 'Help relocate the refuses',
			TotalDonated: 21840,
		},
		{
			donatedImage: 'https://demo1.imithemes.com/html/born-to-give/images/causeg6.jpg',
			donatedTitle: 'Help relocate the refuses',
			TotalDonated: 21840,
		},
	];
		...
		<div className='w-[90%] flex justify-center items-center flex-col md:max-w-[85%] mx-auto'>
			<div className='flex flex-col md:flex-row items-center space-y-4 md:space-y-0 my-10 md:my-[100px]'>
				...
				<p className='max-w-[675px] text-center md:text-start mx-auto text-[#898989]'>
					Vestibulum quam nisi, pretium a nibh sit amet, consectetur hendrerit mi. Aenean
					imperdiet lacus sit amet elit porta, et malesuada erat bibendum. Cras sed nunc
					massa. Quisque tempor dolor sit amet tellus malesuada, malesuada iaculis eros
					dignissim. Aenean vitae diam id lacus fringilla maximus. Mauris auctor efficitur
					nisl, non blandit urna fermentum nec.
				</p>
			</div>
						...
						<div
							...
							<div className='p-[40px]'>
								...
								<p className='uppercase text-center pt-5 font-semibold text-gray-500'>
									Donated:{' '}
									<span className='text-blue-400'> {item.TotalDonated}</span>
								</p>
							</div>
						</div>
					))}
